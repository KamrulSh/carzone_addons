...
class PartnerView(models.TransientModel):
    ...
    def get_dynamic_xlsx_report(self, data, response, report_data, dfr_data):
        ...
        sheet.write(5, col + 0, 'Date', cell_format)
        sheet.write(5, col + 1, 'JRNL', cell_format)
        sheet.write(5, col + 2, 'Account', cell_format)
        sheet.write(5, col + 3, 'Move', cell_format)
        sheet.write(5, col + 4, 'Entry Label', cell_format)
        sheet.write(5, col + 5, 'Debit', cell_format)
        sheet.write(5, col + 6, 'Credit', cell_format)
        sheet.write(5, col + 7, 'Balance', cell_format)
