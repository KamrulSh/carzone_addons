...
class AgeingView(models.TransientModel):
    ...
    def get_dynamic_xlsx_report(self, data, response, report_data, dfr_data ):
        ...
        sheet.write(7, col, 'Entry Label', sub_heading)
        sheet.write(7, col + 1, 'Due Date', sub_heading)
        sheet.write(7, col + 2, 'Journal', sub_heading)
        sheet.write(7, col + 3, 'Account', sub_heading)
        sheet.write(7, col + 4, 'Not Due', sub_heading)
        sheet.write(7, col + 5, '0 - 30', sub_heading)
        sheet.write(7, col + 6, '30 - 60', sub_heading)
        sheet.write(7, col + 7, '60 - 90', sub_heading)
        sheet.write(7, col + 8, '90 - 120', sub_heading)
        sheet.write(7, col + 9, '120 +', sub_heading)
